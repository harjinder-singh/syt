...
function GalleryCustomizer(props) {
    ...
    function retrieveUserImages() {
        axios({
            ...
            headers: {'Content-Type': 'application/json', 'Authorization': 'Token beb637498451730a9812fbdff54163f104404e9d'},
    ...
    return(
        <React.Fragment>
            <div className="blog-entry">
                ...
                <a href="" className="img img-2" style={{backgroundImage: 'url(/media + ${images[0].pic})'}}></a>
                <div className="text text-2 pt-2 mt-3">
                    <div className="meta-wrap">
                        <p className="meta">
                            <span></span>
